...
public class RSDCadastro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_tela_rsdcadastro);
        ...
        navigationDrawerLeft = new DrawerBuilder()
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        switch (position) {
                            ...
                            case 2: {
                                Toast.makeText(RSDCadastro.this, "Mandar parâmetro para setar RMLFragment no TelaHome", Toast.LENGTH_SHORT).show();
                                break;
                            }
                            case 3: {
                                Toast.makeText(RSDCadastro.this, "Mandar parâmetro para setar RSDFragment no TelaHome", Toast.LENGTH_SHORT).show();
                                break;
                            }
                        }
                        Toast.makeText(RSDCadastro.this, "onItemClick: " + position, Toast.LENGTH_SHORT).show();
                        return false;
                    }
                })
                .withOnDrawerItemLongClickListener(new Drawer.OnDrawerItemLongClickListener() {
                    ...
                    public boolean onItemLongClick(View view, int position, IDrawerItem drawerItem) {
                        Toast.makeText(RSDCadastro.this, "onItemLongClick: " + position, Toast.LENGTH_SHORT).show();
                        return false;
                    }
                })
                .build();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.rsdcadastro, menu);
        return true;
    }
