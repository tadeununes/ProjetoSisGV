 ...
 */
public class RMLFragment extends Fragment implements RecyclerViewOnClickListenerHack, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_rml, container, false);

        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("RML");

        setFloatingActionButton(view);

        mRecyclerView = (RecyclerView) view.findViewById(R.id.rv_list_rml);
    ...
    public void setFloatingActionButton(View view) {
        ...
        fab = (FloatingActionMenu) view.findViewById(R.id.fab_rml);
        ...
        FloatingActionButton fab1 = (FloatingActionButton) view.findViewById(R.id.fab1_rml);
        FloatingActionButton fab2 = (FloatingActionButton) view.findViewById(R.id.fab2_rml);
